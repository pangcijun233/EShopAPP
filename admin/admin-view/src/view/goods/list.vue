    ...
    <el-col :span="24" class="warp-main" v-loading="loading" element-loading-text="拼命加载中">
      ...
      <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
        <el-form :inline="true" :model="filters">
          <el-form-item>
            <el-input v-model="filters.name" placeholder="商品名称" @keyup.enter.native="handleSearch">
            </el-input>
          </el-form-item>

          <el-form-item>
            <el-button type="primary" icon="el-icon-search" :loading="loading" v-on:click="handleSearch">
              查询
            </el-button>
          </el-form-item>
      ...
      <el-table :data="dataList" highlight-current-row @selection-change="selsChange" style="width: 100%;">
        ...
        <el-table-column prop="picid" label="商品图片资源id"></el-table-column>
        <el-table-column prop="picpath" label="商品图片存储地址"></el-table-column>
